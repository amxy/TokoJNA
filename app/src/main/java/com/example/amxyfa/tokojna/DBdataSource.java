...
public class DBdataSource {
    ...
    public Barang createBarang(String nama, String harga, Integer stok) {
...
// debug LOGCAT
        ...
        barang.setStok_barang(Integer.valueOf(cursor.getString(3)));
...
// select all SQL query
        Cursor cursor = database.query(DBHelper.TABLE_NAME,
                allColumns, DBHelper.COLUMN_ID, null, null, null, null);
...
// Make sure to close the cursor
    ...
    public void updateBarang() {
        ...
        args.put(DBHelper.COLUMN_STOK, 0 );
        database.update(DBHelper.TABLE_NAME, args,null, null);
    }
}
